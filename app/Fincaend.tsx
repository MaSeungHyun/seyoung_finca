            ...
            <div className="end-container">
                ...
                <div className="end-text">
                    ...
                    <div className="end-subtitle-one">
                        ...
                        <div className="one-text2">
                            대표이사:조민정,김주선 대표전화
                        </div>

                    </div>
                    <div className="end-subtitle-two">
                        <div className="two-text1">
                            Help center
                        </div>
                        <div className="two-text2">
                            070-7537-3773

                        </div>
                        <div className="two-text3">
                            10:00~16:00
                        </div>

                    </div>
                    <div className="end-subtitle-three">
                        <div className="three-text1">
                            about

                        </div>
                        <div className="three-text2">
                            terms of use
